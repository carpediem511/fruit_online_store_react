...
const SuccessModal = ({ closeModal }) => {
	const handleOrderConfirmation = () => {
		// Выполните необходимые действия для подтверждения заказа

		// После успешного подтверждения заказа, перезагрузите страницу
							...
							<div className="bg-white p-6 rounded-2xl text-left shadow-xl">
								...
								<div className="mt-2">
									<p className="text-sm text-gray-500">
										Ваш заказ успешно оформлен. Мы отправили вам электронное письмо со всеми деталями вашего заказа.
									</p>
								</div>
								<div className="mt-4">
									<button
